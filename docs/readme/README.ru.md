...
устроено вместе), [BRIEF.md](../../BRIEF.md) (решения по проектированию),
[docs/ADMIN.md](../ADMIN.md) (администрирование сервера),
...
- libsodium, SQLite и Dear ImGui: загружаются один раз через скрипт,
  никогда автоматически через CMake (BRIEF.md 15)
