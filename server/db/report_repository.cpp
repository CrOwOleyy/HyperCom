                                   ...
                                   report_row &out)
{
    ...
    // target_pubkey is NULL for a post report: a missing column yields an
    // empty blob, not an error -- the field just stays zeroed.
...
{
    sql_statement statement{database_, std::string{SELECT_COLUMNS} +
